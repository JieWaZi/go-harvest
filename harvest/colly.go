...
func newRequest(req *colly.Request, ctx *ExecutorContext) *Request {
	return &Request{
		URL:     req.URL,
		Headers: req.Headers,
		Method:  req.Method,
...
func newResponse(res *colly.Response, ctx *ExecutorContext) *Response {
	return &Response{
...
func newHTMLElement(el *colly.HTMLElement, ctx *ExecutorContext) *HTMLElement {
	return &HTMLElement{
		Name:     el.Name,
		Text:     el.Text,
...
func newXMLElement(el *colly.XMLElement, ctx *ExecutorContext) *XMLElement {
	return &XMLElement{
		Name:     el.Name,
		Text:     el.Text,
		Request:  newRequest(el.Request, ctx),
